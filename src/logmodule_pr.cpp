...
struct PlayRequestLogger::Impl {
    ...
    Impl(PlayRequestLogger &mod) : module(mod), fCallbackMutex(AL::ALMutex::createALMutex()) {
        ...
        try {
            memoryProxy->declareEvent("CallChild", "PlayRequestLogger");
            memoryProxy->declareEvent("EndSession", "PlayRequestLogger");
            memoryProxy->subscribeToEvent("StartSession", "PlayRequestLogger", "onStartLogger");
            childCount = 0;
        }
        catch (const AL::ALError& e) {
    ...
    void startLogger() {
        ...
        try {
            ...
            memoryProxy->subscribeToEvent("ChildCalled", "PlayRequestLogger", "onChildCalled");
            memoryProxy->subscribeToEvent("EndSession", "PlayRequestLogger", "onStopLogger");
            memoryProxy->subscribeToEvent("KlasifikacijaGovoraEvent", "PlayRequestLogger", "onSoundClassified");
...
void PlayRequestLogger::onStartLogger() {
    ...
    impl->memoryProxy->unsubscribeToEvent("StartSession", "PlayRequestLogger");
    ...
    impl->memoryProxy->subscribeToEvent("ChildCalled", "PlayRequestLogger", "onChildCalled");
}
...
void PlayRequestLogger::onStopLogger(const std::string &key, const AL::ALValue &value, const AL::ALValue &msg) {
    ...
    AL::ALCriticalSection section(impl->fCallbackMutex);
    // Unsubscriptions
    impl->memoryProxy->unsubscribeToEvent("EndSession", "PlayRequestLogger");
    ...
    try {
        impl->memoryProxy->unsubscribeToEvent("FaceDetected", "PlayRequestLogger");
        impl->memoryProxy->subscribeToEvent("StartSession", "PlayRequestLogger", "onStartLogger");
    }
    catch (const AL::ALError& e) {
...
void PlayRequestLogger::onChildCalled(const std::string &key, const AL::ALValue &value, const AL::ALValue &msg) {
    ...
    AL::ALCriticalSection section(impl->fCallbackMutex);
    // Unsubscription
    impl->memoryProxy->unsubscribeToEvent("ChildCalled", "PlayRequestLogger");
    // Update the time of the last call
